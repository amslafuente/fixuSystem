...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Clinica',
            fields=[
                ('idClinica', models.AutoField(primary_key=True, serialize=False, unique=True)),
                ...
                ('picturefile', models.ImageField(blank=True, null=True, upload_to='clinica/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('officeID', models.CharField(max_length=10, verbose_name='Número/Identificación')),
