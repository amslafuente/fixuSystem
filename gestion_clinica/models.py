...
class Profesional(models.Model):
    ...
    numcolegiado  = models.CharField("Núm. Colegiado/a", blank = True, max_length = 25)
    position = models.CharField('Puesto/Cargo', max_length = 100)
    ...
    email = models.EmailField("Email", max_length = 50)            
    phone1 = models.PositiveIntegerField("Teléfono 1")                  
    phone2 = models.PositiveIntegerField("Teléfono 2", blank = True, null = True)
